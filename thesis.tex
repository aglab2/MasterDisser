...
Для обеспечения такой подгрузки данных файла в страницы, $Mach$ часть ядра $xnu$ предоставляет подсистему кэширования данных файла $UBC$ и подсистему виртуальной памяти $vm\_map$. Это рассмотрение будет необходимо для осуществления фильтрации пустых страниц, см TODO.
